...
import { getAll, add, edit, remove } from "../../actions/buku";

const fields = ['Judul', 'NamaPengarang', 'NamaPenerbit', 'TahunTerbit', 'KodeRak', 'action'];
                ...
                <CRow>
                    <CCol xs="12" lg="12">
                        <CCard>
                            <CCardHeader>
                                <CRow>
                                    <CCol xs="12" lg="10">Daftar Buku</CCol>
                                    <CCol xs="12" lg="2">
