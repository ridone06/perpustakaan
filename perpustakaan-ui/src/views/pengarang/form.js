...
import { getById, save, backToList } from "../../actions/pengarang";

class FormPengarang extends Component {
    constructor(props) {
        super(props);
...
const mapStateToProps = (state) => ({
    ...
    dataId: state.pengarang.dataId,
    disabled: state.pengarang.disabled,
