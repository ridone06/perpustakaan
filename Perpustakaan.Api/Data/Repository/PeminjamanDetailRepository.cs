...
{
    public class PeminjamanDetailRepository : BaseRepositoryWithoutId<PeminjamanDetail>, IPeminjamanDetailRepository
    {
        public PeminjamanDetailRepository(PerpustakaanContext context) : base(context) { }
